    ...
    return (
        <div>
            <form onSubmit={handleForm} className='card bg-gray-400 bg-opacity-50 px-8 py-6 mx-52 mt-11 shadow-xl'>
                ...
                <input type="text" name='nombre' placeholder="Type here" onChange={handleInputChange} className="input input-bordered mt-2 bg-white mb-1" />
                ...
                <input type="text" name='puntos'placeholder="Type here" onChange={handleInputChange} className="input input-bordered mt-2 bg-white mb-1" />
                ...
                <div className='flex'>
                    <div className='flex-1'>
                        <button type="button" onClick={handleForm} className="btn btn-defult mt-8 mr-80 shadow-lg">Crear</button>
                    </div>
